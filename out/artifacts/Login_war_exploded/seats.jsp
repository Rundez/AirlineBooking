...
<body>
    ...
    <table>
        <thead>
        <tr>
            <th>Buisness <br> Price: 1000 Nok</th>
            <th>Econom <br>  Price:  500 Nok <br> </th>
        ...
        <td><form><input type="submit" name="knapp" class="btn btn-primary"  value="Choose Business"/></form></td>
        <td><form><input type="submit" name="knapp" class="btn btn-primary"  value="Choose Economy"/></form></td>
